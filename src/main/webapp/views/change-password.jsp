	...
	<section class="container mt-5 d-flex"> <!-- d-flex: !important -->
        <div class="w-auto mx-auto bg-body-secondary p-5 rounded-4">
            ...
            <form class="mt-3" action="">
                ...
                <input class="form-control mt-3" type="password" placeholder="Recent Password" name="recentPassword">
                <input class="form-control mt-3" type="password" placeholder="New Password" name="newPassword">
                <input class="form-control mt-3" type="password" placeholder="New Password Again" name="confirmPassword">
